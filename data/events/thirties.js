export const thirtiesEvents = [
  {
    ...
    description: "El municipio prepara la licitación de una carretera largamente prometida. Una constructora te pide movilizar respaldo para ajustar las bases a su favor.",
    options: [
      { id: "licitacion-limpia", label: "Exigir una licitación transparente", hint: "La obra tardará, pero el expediente resistirá", effects: { approval: -5, influence: 3, legalRisk: -4 }, outcomes: [{ id: "obra-transparente", weight: 100, text: "La presión ciudadana frena el arreglo. La demora irrita al pueblo, aunque Contraloría respalda el proceso.", effects: { influence: 3 }, addTags: ["gestion-limpia"], nextEvent: "provincia-control-obra" }] },
      { id: "arreglo-constructora", label: "Movilizar apoyo para el trato", hint: "Obra rápida · pago político oculto", effects: { approval: 12, influence: 9, dirtyMoney: 38000, legalRisk: 18 }, addTags: ["favor-constructor"], outcomes: [{ id: "obra-inaugurada", weight: 70, text: "La carretera abre a tiempo. La constructora atribuye el resultado a tu gestión política y nadie pregunta por el pago.", effects: { approval: 9 }, nextEvent: "provincia-favor-cobrado" }, { id: "audio-filtrado", weight: 30, text: "Un audio del acuerdo llega a una radio local. La fiscalía abre diligencias.", effects: { approval: -22, legalRisk: 42 }, addTags: ["investigado"], nextEvent: "fiscalia-cerca" }] },
    ],
  },
  {
    id: "salto-regional",
    weight: 12,
    requirements: { all: [{ age: { min: 30, max: 52 } }, { stat: "approval", min: 38 }, { not: { careerTrack: "publicAuthority" } }] },
  ...
  },
  {
    ...
    cooldown: 5,
    weight: 10,
    requirements: { all: [{ age: { min: 30, max: 60 } }, { role: "Alcalde" }] },
  ...
  },
  {
    ...
    title: "Un lugar en la próxima lista de Diputados",
    kicker: "Elección interna · preparar el siguiente ciclo",
    description: "Tu organización empieza a ordenar la lista para la próxima elección general. Un número competitivo exige trabajo territorial desde ahora, aunque todavía no entrega una curul.",
    options: [
      { id: "postular-congreso", label: "Disputar un número competitivo", hint: "Base electoral · costo de organización", effects: { cleanMoney: -18000, influence: 7 }, outcomes: [{ id: "curul-ganada", weight: 48, headline: "Aseguras un lugar competitivo en la lista", text: "La interna te favorece y empiezas a organizar personeros y equipos para la elección general.", effects: { approval: 5, influence: 10 }, setRole: "Candidato a Diputado", addTags: ["candidato-interno", "experiencia-electoral"] }, { id: "curul-perdida", weight: 52, headline: "La interna te relega a un número sin posibilidades", text: "Rechazas el puesto decorativo y mantienes tu organización para negociar en el siguiente ciclo.", effects: { approval: -3, influence: 3 }, setRole: "Dirigente político", addTags: ["experiencia-electoral"] }] },
      { id: "dirigir-lista", label: "Organizar la futura campaña de la lista", hint: "Menor exposición · honorarios seguros", effects: { cleanMoney: 21000, influence: 8 }, outcomes: [{ id: "operador-legislativo", weight: 100, text: "Los futuros candidatos quedan en deuda contigo antes de que empiece la campaña.", addTags: ["operador"] }] },
    ],
  },
  {
    id: "candidatura-alcaldia", maxOccurrences: 1, weight: 14, requirements: { all: [{ age: { min: 30, max: 47 } }, { stat: "approval", min: 35 }, { not: { careerTrack: "nationalInstitution" } }, { not: { role: ["Alcalde", "Gobernador regional"] } }] }, category: "election",
